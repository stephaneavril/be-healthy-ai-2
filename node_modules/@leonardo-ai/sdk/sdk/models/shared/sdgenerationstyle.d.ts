 ...
 */
export declare enum SdGenerationStyle {
    Anime = "ANIME",
    Bokeh = "BOKEH",
    Cinematic = "CINEMATIC",
...
/** @internal */
export declare const SdGenerationStyle$inboundSchema: z.ZodNativeEnum<typeof SdGenerationStyle>;
/** @internal */
export declare const SdGenerationStyle$outboundSchema: z.ZodNativeEnum<typeof SdGenerationStyle>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace SdGenerationStyle$ {
    /** @deprecated use `SdGenerationStyle$inboundSchema` instead. */
    const inboundSchema: z.ZodNativeEnum<typeof SdGenerationStyle>;
    /** @deprecated use `SdGenerationStyle$outboundSchema` instead. */
    const outboundSchema: z.ZodNativeEnum<typeof SdGenerationStyle>;
}
//# sourceMappingURL=sdgenerationstyle.d.ts.map